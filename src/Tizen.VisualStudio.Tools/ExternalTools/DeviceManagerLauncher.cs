...
namespace Tizen.VisualStudio.Tools.ExternalTool
{
    ...
    /// </summary>
    public sealed class DeviceManagerLauncher : ExternalToolLauncher
    {
        private const string DeviceMgrDesc = "Device Manager";
        //private ToolsInfo toolInfo = ToolsInfo.Instance();
        private static ProcessStartInfo pInfo = new ProcessStartInfo();

        public DeviceManagerLauncher() : base(DeviceMgrDesc, pInfo, false)
        {
            pInfo.FileName = ToolsPathInfo.DeviceMgrPath;
