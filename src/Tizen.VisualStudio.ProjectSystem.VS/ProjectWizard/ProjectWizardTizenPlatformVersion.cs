...
{
    internal class ProjectWizardTizenPlatformVersion : IWizard
    {
        ...
        public void RunStarted(object automationObject, Dictionary<string, string> replacementsDictionary, WizardRunKind runKind, object[] customParams)
        {
            ...
            List<string> platformVersionList = new List<string>() { "4.0", "5.0", "5.5", "6.0", "6.5", "7.0"};
            ...
            if (nWizard.platformVersion != "4.0")
                replacementsDictionary.Add("$useHotReload$", "true");
            else
                replacementsDictionary.Add("$useHotReload$", "false");
        }
