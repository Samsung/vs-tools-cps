...
namespace Tizen.VisualStudio.ProjectSystem.VS.PropertyPages
{
       ...
       IVsDebuggerEvents
    {
        ...
        /// Helper to wait on async tasks
        /// </summary>
        private void WaitForAsync(Func<System.Threading.Tasks.Task> asyncFunc)
        {
        ...
        {
            System.IServiceProvider sp = new Microsoft.VisualStudio.Shell.ServiceProvider((Microsoft.VisualStudio.OLE.Interop.IServiceProvider)hier.GetDTEProject().DTE);
            try
            {
            ...
            {
                (sp as Microsoft.VisualStudio.Shell.ServiceProvider).Dispose();
            }
