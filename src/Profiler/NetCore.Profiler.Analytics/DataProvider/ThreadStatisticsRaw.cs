...
{
    public class ThreadStatisticsRaw : IThreadStatisticsRaw
    {
        public IProfilingStatisticsTotals Totals { get; set; }

        public List<ISourceLineStatistics> Lines { get; set; }

        public List<IMethodStatistics> Methods { get; set; }

        public List<ICallStatisticsTreeNode> CallTree { get; set; }

        public List<IHotPath> HotPaths { get; set; }
