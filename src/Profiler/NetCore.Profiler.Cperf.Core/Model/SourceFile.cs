...
namespace NetCore.Profiler.Cperf.Core.Model
{
    ...
    public class SourceFile : IIdentifiable
    {
        ...
        {
            return TypeDescriptor.GetProperties((object)this).Cast<PropertyDescriptor>()
                .Aggregate("SourceFile[", (current, descriptor) => current + ("{" + descriptor.Name + ": " + descriptor.GetValue(this) + "}")) + "]";
        }
    }
}
